...
const PlaceItem = props=>{
    ...
    const confirmDeleteHandler= async () => {
        ...
        try{
            ...
            await sendRequest(`${process.env.REACT_APP_BACKEND_URL}/places/${props.id}`, 'DELETE', null, {Authorization: 'Bearer '+ auth.token}); //null is for the body...we do not want to send any body with DELETE requests
